...
public class ImageServlet extends HttpServlet {
	...
	private static final long serialVersionUID = -8476204640117827016L;
	...
	private ImageMiddleResult excute(HttpServletRequest request) throws IOException {
		...
		// 图片ID
		Integer imgeId = Integer.parseInt(request.getParameter("id"));
		// 图片缩放
...
//		String kind = request.getParameter("kind");
		...
		// 标识内存中是否有操作图片
		if (imgeId != null) {// 若没有id，直接null

			ImageInfo imageInfo = imageInfoService.imageInfoById(imgeId);
