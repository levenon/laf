 ...
 * */
@Service
public class Method18_1_0 extends BaseMethod {

	private String remoteServerUrl = ResourceBundle.getBundle("application").getString("remote.uploadUrl");
	...
	public JSONArray dealWithParams(Login login, JSONObject params) {
		return uploadFileServer(login, params);
	}
	...
	public IService matchVersion(String version) {
		...
		if (versions.equals(version)) {
			return (IService) ContextUtil.getContext().getBean("method18_1_0");
		}
		return null;
	}
	...
	private JSONArray uploadFileServer(Login login, JSONObject params) {
